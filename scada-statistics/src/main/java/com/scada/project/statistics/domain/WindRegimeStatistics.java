...
/**
 * 风况统计按天统计对象 t_wind_regime_statistics
 * 
 * @author 张继勇
 * @date 2020-05-15
 */
public class WindRegimeStatistics extends BaseEntity
{
    ...
    public void setAvgOverfall(Double avgOverfall) 
    {
        this.avgOverfall = avgOverfall;
    }

    public Double getAvgOverfall() 
    {
        return avgOverfall;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("avgOverfall", getAvgOverfall())
